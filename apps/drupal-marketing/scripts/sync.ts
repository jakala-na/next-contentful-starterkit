...
(async () => {
  ...
  const authClient = await drupalAuthClient(process.env.DRUPAL_AUTH_URI!, 'client_credentials', {
    clientId: process.env.DRUPAL_VIEWER_CLIENT_ID!,
    clientSecret: process.env.DRUPAL_VIEWER_CLIENT_SECRET!,
  });
